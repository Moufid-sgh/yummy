import { Sheet, SheetTrigger, SheetDescription, SheetContent, SheetHeader, SheetTitle, SheetClose } from "@/components/ui/sheet"
        ...
        <Sheet open={isOpen} onOpenChange={handleSheetStateChange}>
            ...
            <SheetContent>
                        ...
                        <ScrollArea dir="rtl" className="h-[500px] 2xl:h-[700px]">
                            {
                                Array.isArray(results.recipes) && results.recipes.map(el => {
                                    return (
                                        <div onClick={() =>gotTo(el.id)} key={el.id} className="relative group flex items-center my-4 cursor-pointer">
                            ...
                            {
                                !noResults &&
                                (<p dir="rtl" className="bg-[#5684EB] text-white rounded-[4px]  p-2 ">
                ...
                <SheetClose asChild className="absolute top-5 right-5">
                    <button onClick={handleSheetClose}>&#10005;</button>
                </SheetClose>
            </SheetContent>
        </Sheet>
    )
