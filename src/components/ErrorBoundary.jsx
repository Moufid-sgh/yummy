...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="p-6 border border-red rounded-[4px] w-fit">
          <div className="flex">
            ...
            <p className="font-semibold text-lg mb-4 mr-1">حدث خطأ ما !!</p>
          </div>
          <button onClick={() => window.location.reload()} className="bg-green-500 hover:bg-green-300 text-white rounded-[4px] px-4 py-1.5">
            إعادة تحميل الصفحة
          </button>
        </div>
      );
