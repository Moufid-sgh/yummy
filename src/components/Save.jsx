...
const Save = ({ recipeId }) => {
    ...
    return (
        <div className="group absolute bottom-0 right-2 py-[9px] px-1.5 z-50 rounded-t-[8px] bg-white hover:bg-orange hover:text-white duration-300">
            <svg onClick={(e) => {
                e.stopPropagation();
                e.preventDefault();
                handleSave();
            }}
                className={`${isSaved ? 'text-orange hover:text-white' : ''} mb-1.5 md:mb-0 cursor-pointer active:heart`} width="20" height="17" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
