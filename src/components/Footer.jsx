  ...
  return (
    <footer dir='rtl' className="footerBg w-full text-white px-3 md:px-8 lg:px-32 py-8">
      ...
      <section className="flex mt-8">
        <a href="mailto:hello@yahalawa.net" className="border-l border-darkblue pl-2 md:pl-4 hover:text-blue duration-300">إتصل بنا</a>
        <Link to="/about_us" className="border-l border-darkblue px-2 md:px-4 hover:text-blue duration-300">معلومات عنا</Link>
        <Link to="/terms" className="px-2 md:px-4 hover:text-blue duration-300">سياسة الخصوصية</Link>
      </section>

      <section className="text-sm mt-8 space-y-2">
        <Link to="/terms_of_TT" className="hover:text-blue duration-300">الشروط العامة للبيع والإستخدام خدمة “ Yummy صنافة ” من أورنج.</Link>
